"""Base class for message stat sub-modules."""
...
class MessageStatsBase:
    """
    Base class for message stat modules.
    
    Provides all utility functions without requiring abstract methods.
    Sub-modules use calculate() instead of calculate_all().
    """
    ...
    # Copy all utility methods from BaseCalculator
    # (This avoids the abstract method issue)
